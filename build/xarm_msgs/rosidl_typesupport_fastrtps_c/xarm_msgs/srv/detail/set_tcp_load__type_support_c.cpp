  ...
  void * untyped_ros_message)
{
  ...
  // Field name: center_of_gravity
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->center_of_gravity, size)) {
      fprintf(stderr, "failed to create array for field 'center_of_gravity'");
      return false;
    }
    auto array_ptr = ros_message->center_of_gravity.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xarm_msgs__srv__SetTcpLoad_Request;
    is_plain =
      (
...
static size_t _SetTcpLoad_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_xarm_msgs__srv__SetTcpLoad_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xarm_msgs__srv__SetTcpLoad_Response;
    is_plain =
      (
...
static size_t _SetTcpLoad_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_xarm_msgs__srv__SetTcpLoad_Response(
    full_bounded, is_plain, 0);
