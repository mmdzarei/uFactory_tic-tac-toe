...
class CIOState(metaclass=Metaclass_CIOState):
    ...
    def __eq__(self, other):
        ...
        if self.code != other.code:
            return False
        if any(self.input_digitals != other.input_digitals):
            return False
        if any(self.output_digitals != other.output_digitals):
            return False
        if any(self.input_analogs != other.input_analogs):
            return False
        if any(self.output_analogs != other.output_analogs):
            return False
        if any(self.input_conf != other.input_conf):
            return False
        if any(self.output_conf != other.output_conf):
            return False
        return True
