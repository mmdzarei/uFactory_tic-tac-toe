...
inline void to_flow_style_yaml(
  const LinearMotorBackOrigin_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: wait
  ...
  {
    out << "auto_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.auto_enable, out);
  }
  out << "}";
...
inline std::string to_yaml(const LinearMotorBackOrigin_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const xarm_msgs::srv::LinearMotorBackOrigin_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const xarm_msgs::srv::LinearMotorBackOrigin_Request & msg)
{
...
inline void to_flow_style_yaml(
  const LinearMotorBackOrigin_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: ret
...
inline std::string to_yaml(const LinearMotorBackOrigin_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use xarm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const xarm_msgs::srv::LinearMotorBackOrigin_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  xarm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use xarm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const xarm_msgs::srv::LinearMotorBackOrigin_Response & msg)
{
  return xarm_msgs::srv::to_yaml(msg);
}
