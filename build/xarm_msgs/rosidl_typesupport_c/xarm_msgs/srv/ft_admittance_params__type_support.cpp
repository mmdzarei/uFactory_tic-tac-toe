...
static const _FtAdmittanceParams_Request_type_support_symbol_names_t _FtAdmittanceParams_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, FtAdmittanceParams_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtAdmittanceParams_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, FtAdmittanceParams_Request)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::FtAdmittanceParams_Request_message_type_support_handle;
}
...
static const _FtAdmittanceParams_Response_type_support_symbol_names_t _FtAdmittanceParams_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, FtAdmittanceParams_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtAdmittanceParams_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, FtAdmittanceParams_Response)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::FtAdmittanceParams_Response_message_type_support_handle;
}
...
static const _FtAdmittanceParams_type_support_symbol_names_t _FtAdmittanceParams_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xarm_msgs, srv, FtAdmittanceParams)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xarm_msgs, srv, FtAdmittanceParams)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, xarm_msgs, srv, FtAdmittanceParams)() {
  return &::xarm_msgs::srv::rosidl_typesupport_c::FtAdmittanceParams_service_type_support_handle;
}
